        ...
        <div className="rules">
            ...
            <div>
                <IDiv className="rules-card">
                    ...
                    <video className="rules-media-display" muted autoPlay loop src={card} type="video/mp4"></video>
                </IDiv>
                <IDiv className="rules-chart">
                    ...
                    <div>
                        ...
                        <img className="rules-media-display" src={chart}></img>
                    </div>
                </IDiv>
                <IDiv className="rules-balance">
                    ...
                    <div>
                        ...
                        <video className="rules-media-display" muted autoPlay loop src={technicals} type="video/mp4"></video>
                    </div>
                ...
                <IDiv className="rules-buying-selling">
                    ...
                    <div className="rules-buying-selling-modal-example">
                        <video className="rules-media-display" muted autoPlay loop src={technicals} type="video/mp4" src={modal}></video>
