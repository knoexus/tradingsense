...
import cardImg from '../../images/rules-card.png'
import modalImg from '../../images/rules-modal.png'
import technicalsImg from '../../images/rules-technicals-was.png'
        ...
        <div className="rules">
            ...
            <div>
                <IDiv className="rules-card">
                    ...
                    <video poster={cardImg} className="rules-media-display" muted autoPlay loop src={card} type="video/mp4"></video>
                </IDiv>
